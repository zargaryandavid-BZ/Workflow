...
Bazaar (Admin) writes **[docs/bazaar-inbox.md](docs/bazaar-inbox.md)**. Handshake contract: **[docs/workflow-bazaar-connect.md](docs/workflow-bazaar-connect.md)**. Agents: answer **Open** items **in that file** (not in chat).
